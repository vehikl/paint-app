...
import { Layer, Stage, Rect, Line, Ellipse, Image } from 'react-konva';
...
export const MyCanvas = ({ mouseState, shapes, setShapes }) => {
    ...
    const tools = {
        ...
        ellipse: {
            handleMouseDown: (e) =>
                ellipseTool.handleMouseDown(e, setDrawingEllipse),
            handleMouseMove: (e) =>
                ellipseTool.handleMouseMove(
                    e,
                    drawingEllipse,
                    setDrawingEllipse
                ),
            ...
            <Layer>
                ...
                {shapes.rectangles.map((rect, index) => (
                    <Rectangle
                        ...
                        isSelected={selectedShapes.rectangles?.includes(
                            rect.id
                        )}
                        key={index}
                        {...rect}
                ...
                {shapes.ellipses.map((ellipse, index) => (
                    <EllipseComponent
                        ...
                        isSelected={selectedShapes?.ellipses?.includes(
                            ellipse.id
                        )}
                        key={index}
                        {...ellipse}
